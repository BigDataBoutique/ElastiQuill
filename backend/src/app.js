...
app.use('/favicon.ico', express.static(path.join(__dirname, 'views/base/public/favicon/favicon.ico')));
...
function initConfig() {
  ...
  const envOverrides = [
    ...
    ['credentials.google.gcloud-project-id', 'GOOGLE_GCLOUD_PROJECT_ID'],
    ['credentials.google.gcs-bucket', 'GOOGLE_GCS_BUCKET'],
    ['credentials.google.gcs-keyfile', 'GOOGLE_GCS_KEYFILE'],
