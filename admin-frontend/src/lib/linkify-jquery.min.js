  ...
  var i = (function(n) {
    ...
    function i(e, n, t) {
      for (
        ...
        var f = l;
        if ("nl" === f.type && n.nl2br) i.push(t.createElement("br"));
        else if (f.isLink && n.check(f)) {
          var s = n.resolve(f),
            c = s.formatted,
            u = s.formattedHref,
            y = s.tagName,
          ...
          if (
            ...
            d && v.setAttribute("class", d),
            m && v.setAttribute("target", m),
            h)
          )
            for (var g in h) v.setAttribute(g, h[g]);
          if (k)
            for (var b in k)
              v.addEventListener
                ? v.addEventListener(b, k[b])
                : v.attachEvent && v.attachEvent("on" + b, k[b]);
        ...
        switch (s.nodeType) {
          ...
          case y:
            if (
              ((d = s.nodeValue),
              (m = l(d)),
              0 === m.length || (1 === m.length && m[0] instanceof c))
            )
              break;
      ...
      "function" != typeof n.fn.linkify &&
        ...
        n(i).ready(function() {
          n("[data-linkify]").each(function() {
            ...
            "linkifyAttributes" in t && (o.attributes = t.linkifyAttributes),
              "linkifyDefaultProtocol" in t &&
                (o.defaultProtocol = t.linkifyDefaultProtocol),
              "linkifyEvents" in t && (o.events = t.linkifyEvents),
              "linkifyFormat" in t && (o.format = t.linkifyFormat),
              "linkifyFormatHref" in t && (o.formatHref = t.linkifyFormatHref),
              "linkifyTagname" in t && (o.tagName = t.linkifyTagname),
              "linkifyTarget" in t && (o.target = t.linkifyTarget),
              "linkifyValidate" in t && (o.validate = t.linkifyValidate),
              "linkifyIgnoreTags" in t && (o.ignoreTags = t.linkifyIgnoreTags),
              "linkifyClassName" in t
                ? (o.className = t.linkifyClassName)
                : "linkifyLinkclass" in t && (o.className = t.linkifyLinkclass),
              (o = r.normalize(o));
