...
(function($, window, document) {
  ...
  var pluginName = "mediumInsert",
    ...
    defaults = {
      ...
      placeholder:
        "Paste an YouTube, Vimeo, Facebook, Twitter, Instagram or an image URL and press Enter",
  ...
  Embeds.prototype.parseUrl = function(url, pasted) {
    ...
    html = url
      ...
      .replace(
        ...
        '<div class="video video-youtube"><iframe width="560" height="315" src="//www.youtube.com/embed/$7" frameborder="0" allowfullscreen></iframe></div>'
      )
      .replace(
        /^https?:\/\/vimeo\.com(\/.+)?\/([0-9]+)$/,
      ...
      .replace(
        ...
        '<blockquote class="twitter-tweet" align="center" lang="en"><a href="https://twitter.com/$1/statuses/$2"></a></blockquote><script async="true" src="//platform.twitter.com/widgets.js" charset="utf-8"></script>'
      )
      .replace(
