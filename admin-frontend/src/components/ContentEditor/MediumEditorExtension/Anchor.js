...
// based on https://github.com/yabwe/medium-editor/blob/d113a74437fda6f1cbd5f146b0f2c46288b118ea/src/js/extensions/anchor.js
const AnchorForm = MediumEditor.extensions.form.extend({
  ...
  /* targetCheckboxText: [boolean]
   * default checked value of target checkbox.
   */
  targetCheckboxDefaultChecked: false,
  ...
  handleClick: function(event) {
    ...
    if (!this.isDisplayed()) {
      var target = this.targetCheckboxDefaultChecked ? "_blank" : undefined;
      this.showForm({ value: "", target });
    }
  ...
  getTemplate: function() {
    ...
    if (this.targetCheckbox) {
      ...
      template.push(
        ...
        '<input type="checkbox" class="okay1 medium-editor-toolbar-anchor-target" id="medium-editor-toolbar-anchor-target-field-' +
          this.getEditorId() +
          '">',
    ...
    if (this.customClassOption) {
      ...
      template.push(
        '<div class="medium-editor-toolbar-form-row">',
        '<input type="checkbox" class="okay2 medium-editor-toolbar-anchor-button" id="medium-editor-toolbar-anchor-button-field-' +
          this.getEditorId() +
          '">',
